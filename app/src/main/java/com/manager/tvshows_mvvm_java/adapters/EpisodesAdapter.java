...
import com.manager.tvshows_mvvm_java.databinding.ItemContainerEpisodeBinding;
import com.manager.tvshows_mvvm_java.models.Episode;
...
public class EpisodesAdapter extends RecyclerView.Adapter<EpisodesAdapter.EpisodeViewHolder> {
    ...
    static class EpisodeViewHolder extends RecyclerView.ViewHolder {
        ...
        public EpisodeViewHolder(@NonNull ItemContainerEpisodeBinding itemView) {
            super(itemView.getRoot());
            this.itemContainerEpisodeBinding = itemView;
        }
